          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            >
              <div className="p-6 sm:p-8 relative z-10">
                ...
                <h2 className="serif text-base sm:text-lg md:text-xl font-semibold leading-tight uppercase tracking-wider text-[#011330] mt-2">
                  A Career Is More Than Just A Job.
                </h2>
                <p className="mt-3.5 text-xs sm:text-sm leading-relaxed text-[#5d6971] max-w-xl">
                ...
                <div className="mt-5 flex flex-wrap items-center gap-4 text-xs text-[#727b80] font-semibold">
            ...
            <motion.div
              whileHover={{ y: -3 }}
              transition={{ duration: 0.25 }}
              className="md:col-span-1 rounded-2xl border border-[#BA780E]/30 bg-[#011330] text-[#f8f4ec] p-6 sm:p-8 flex flex-col justify-between shadow-md relative overflow-hidden group"
            >
              <div className="relative z-10">
                <div className="flex items-center justify-between">
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-[#BA780E]/40 bg-[#011330] px-3 py-0.5 text-[.64rem] uppercase tracking-wider text-[#BA780E]">
                    <Users size={12} />
                    <span>Human-to-Human</span>
                  </span>
                  <span className="serif text-lg font-bold text-[#BA780E]">02</span>
                </div>
                <h3 className="serif text-sm sm:text-base md:text-lg font-semibold leading-snug tracking-wider uppercase text-[#f8f4ec] mt-3">
                  Real 1:1 Support
                </h3>
                <p className="mt-2.5 text-xs sm:text-sm leading-relaxed text-[#c4cdd1]">
              ...
              <div className="mt-6 pt-5 border-t border-[#39516a]/70 flex items-center justify-between text-xs text-[#BA780E] font-semibold">
            ...
            <motion.div
              whileHover={{ y: -3 }}
              transition={{ duration: 0.25 }}
              className="md:col-span-1 rounded-2xl border border-[#ded6c7] bg-[#fbf9f5] p-6 sm:p-8 flex flex-col justify-between shadow-sm hover:border-[#BA780E] transition-all group"
            >
              <div>
                <div className="flex items-center justify-between">
                  <span className="eyebrow text-[#BA780E]">Specialized Advisory</span>
                  <span className="serif text-lg font-semibold text-[#BA780E]">03</span>
                </div>
                <h3 className="serif text-sm sm:text-base md:text-lg font-semibold leading-snug tracking-wider uppercase text-[#011330] mt-3">
                  Navigating US Careers
                </h3>
                <p className="mt-2.5 text-xs sm:text-sm leading-relaxed text-[#5d6971]">
              ...
              <div className="mt-6 pt-5 border-t border-[#ded6c7]/80 flex items-center gap-2 text-xs font-bold text-[#011330]">
            ...
            <motion.div
              whileHover={{ y: -3 }}
              transition={{ duration: 0.25 }}
              className="md:col-span-2 rounded-2xl border border-[#BA780E]/40 bg-[#011330] text-[#f8f4ec] p-6 sm:p-8 flex flex-col justify-between shadow-xl relative overflow-hidden group"
            >
              <div className="relative z-10">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-[#BA780E]/40 bg-[#011330]/80 px-3 py-0.5 text-[.64rem] uppercase tracking-wider text-[#BA780E] font-bold">
                    <ShieldCheck size={13} />
                    <span>Transparent Policy</span>
                  </span>
                  <span className="serif text-lg font-semibold text-[#BA780E]">04</span>
                </div>

                <div className="mt-5 grid gap-5 md:grid-cols-[1.3fr_1fr] items-center">
                  <div>
                    <h3 className="serif text-sm sm:text-base md:text-lg font-semibold leading-snug tracking-wider uppercase text-[#f8f4ec]">
                  ...
                  <div className="rounded-xl border border-[#BA780E]/30 bg-[#011330]/90 p-5 backdrop-blur-md text-center">
                    <span className="serif text-3xl sm:text-4xl font-bold text-[#BA780E]">0%</span>
