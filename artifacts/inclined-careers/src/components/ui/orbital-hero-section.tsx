...
export interface OrbitalHeroSectionProps
  ...
  paused?: boolean;
  sunColor?: string;
  /** Optional background base color, defaults to #000000 or custom theme color */
...
export const SOLAR_SYSTEM: Planet[] = [
  ...
  { name: "Saturn",  a: 9.53700, e: 0.05386, i: 2.485, node: 113.665, peri: 339.392, M0: 317.020, color: "#BA780E", size: 4.8 },
...
/** Brand tailored palette for Inclined Careers: Gold, Bronze, Azure, Rose and Amber */
export const INCLINED_SYSTEM: Planet[] = [
  { name: "Mercury", a: 0.38710, e: 0.20563, i: 7.005, node: 48.331, peri: 29.125, M0: 174.796, color: "#fdf3dc", size: 2.4, glow: 1.2 },
  { name: "Venus",   a: 0.72333, e: 0.00677, i: 3.395, node: 76.680, peri: 54.853, M0: 50.115,  color: "#BA780E", size: 3.6, glow: 1.3 },
  { name: "Earth",   a: 1.00000, e: 0.01671, i: 0.000, node: 348.739, peri: 114.208, M0: 357.517, color: "#BA780E", size: 4.0, glow: 1.4 },
  { name: "Mars",    a: 1.52371, e: 0.09339, i: 1.850, node: 49.558, peri: 286.483, M0: 19.373, color: "#BA780E", size: 3.2, glow: 1.2 },
  { name: "Jupiter", a: 5.20290, e: 0.04839, i: 1.303, node: 100.464, peri: 273.867, M0: 20.020, color: "#BA780E", size: 5.4, glow: 1.1 },
  { name: "Saturn",  a: 9.53700, e: 0.05386, i: 2.485, node: 113.665, peri: 339.392, M0: 317.020, color: "#BA780E", size: 4.8, glow: 1.1 },
];
...
export function OrbitalHeroSection({
  ...
  const props = useRef({
    ...
    interactive, paused, sunColor, backgroundColor,
  });
  props.current = {
    planets, yearSeconds, trailYears, compress, maxTurns, planeSpread, eccentricity, alignToCourse, driftSpeed, apex,
    viewRadius, tilt, spin, roll, lead, focus, scrim, scrimStrength, starCount, glow, showOrbits, showSunTrack,
  ...
  useEffect(() => {
    ...
    function render(t: number) {
      ...
      ctx!.fillStyle = C.backgroundColor || "#000000";
      ...
      if (C.scrim !== "none") {
        ...
        const [br, bg, bb] = parseRGB(C.backgroundColor || "#000000");
        const g =
        ...
        for (let q = 0; q <= 12; q++) {
          const x = q / 12;
          g.addColorStop(x, `rgba(${br},${bg},${bb},${(s * Math.pow(1 - x, 2.4)).toFixed(4)})`);
        }
        ctx!.fillStyle = g;
        ctx!.fillRect(0, 0, width, height);
      }
  ...
  return (
    <div
      ...
      style={{ backgroundColor: props.current.backgroundColor || "#000000" }}
      {...rest}
    >
